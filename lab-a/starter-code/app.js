...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var answers = [];
  answers.push(sum(sum(a,b)[0],c)[0]);
  answers.push(multiply(multiply(a,b)[0],c)[0]);
  answers.push(`${a} and ${b} and ${c} sum to ${answers[0]}.`);
  answers.push(`The product of ${a} and ${b} and ${c} is ${answers[1]}.`);
  return answers;
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  return [totalProduct, `The numbers ${dynamicArray} have a product of ${totalProduct}.`];
}
